...
#   age = models.PositiveSmallIntegerField(blank=True,null=True,verbose_name="年龄")
  ...
  operateRecord = models.FileField(upload_to=settings.records,blank=True,null=True,verbose_name="解剖记录")
  pptRecord = models.FileField(upload_to=settings.ppt,blank=True,null=True,verbose_name="PPT")
